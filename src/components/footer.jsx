            ...
            <div className="footer footer-animated" style={{zIndex: 20}}>
                <div>
                    <a href="#" className="back-to-top" onClick={this.scrollToTop}>
                        <Chevron SVGData= {this.chevronSVG}/>
                    </a>
                </div>
